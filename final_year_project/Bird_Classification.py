...
model = load_model('deeplearnig/Abhi_preditionmodel19.h5',compile=False)
#model = load_model('/Users/abhinashsathi/Downloads/EfficientNetB4-BIRDS-0.99.h5',compile=True)
...
#lab={0:"doves",1:"hens",2:"hummingbirds",3:"owls",4:"parrots"}
...
def run():
    ...
    st.title("Bird Identification")
    

    img_file = st.file_uploader("Choose an Image of Bird", type=["jpg","jpeg" ,"png"])
    if img_file is not None:
        ...
        if st.button("Predict"):
            ...
            if result!=-1:
                s="Bird Found :"+result
                st.success("Bird Found ")
                os.rename(os.path.join(save_image_path), r'./uploads/image.jpg')
                
                #soundproducing , Database upadting and sending notification
                from python_services import DB_test, smspython, sound
